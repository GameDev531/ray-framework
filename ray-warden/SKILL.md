...
| `references/analyst_playbooks.md` | at Step 2, per alert class | The five-beat triage frame, the per-class playbooks (auth, phishing, endpoint, exfiltration, IoC), the correlation method, and the confidence rubric that gates autonomy |
