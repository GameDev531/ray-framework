...
<ul>
  <li><strong>Packaging:</strong> Installs as a Claude Code plugin (<code>ray@ray-framework</code>) via the bundled <code>.claude-plugin/</code> marketplace; validated with <code>claude plugin validate --strict</code>, all 32 skills and 5 subagents load, plus the <code>ray-tools</code> MCP server.</li>
