...
Usage:
    python3 scripts/ray_conductor.py begin  --target . [--state .] [--sync]
    python3 scripts/ray_conductor.py archive --state . --pass 1
    python3 scripts/ray_conductor.py show    --state .
"""
import argparse
import hashlib
import json
